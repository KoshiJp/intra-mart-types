/**
 * SystemStorage にアクセスするためのクラスです。
 */
declare class SystemStorage {
    /**
     * コンストラクタ。path を指す SystemStorage を作成します。
     * @param path 
     */
    ...
    /**
     * コンストラクタ。storage と同一のパスを指す SystemStorage を作成します。
     * @param storage 
     */
     ...
     * @param child 
     */
    constructor(parent: SystemStorage, child: string);
     ...
     * @param overwrite 
     */
    copy(to: SystemStorage, overwrite?: boolean): boolean;
     ...
     * @param recursive 
     */
    directoriesStorages(recursive?: boolean): SystemStorage[];
     ...
     * @param recursive 
     */
    filesStorages(recursive: boolean): SystemStorage[];
    ...
    // 親ストレージを返します。
    getParentStorage(): SystemStorage;
     ...
     * @param target 
     */
    getRelativePath(target: SystemStorage): string;

    /**
     * ルートストレージを返します。
     */
    getRootStorage(): SystemStorage;
     ...
     */
    listStorages(filterOrRecursive?: object): SystemStorage[];
     ...
     * @param other 
     */
    resolve(other: string): SystemStorage;
