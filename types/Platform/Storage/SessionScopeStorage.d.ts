/**
 * SessionScopeStorage にアクセスするためのクラスです。
 */
declare class SessionScopeStorage {
    /**
     * コンストラクタ。storage と同一のパスを指す SessionScopeStorage を作成します。
     * @param storage 
     */
    constructor(storage: SessionScopeStorage);
     ...
     * @param child 
     */
    constructor(parent: SessionScopeStorage, child: string);
     ...
     * @param overwrite 
     */
    copy(to: SessionScopeStorage, overwrite?: boolean): boolean;
     ...
     * @param recursive 
     */
    directoriesStorages(recursive?: boolean): SessionScopeStorage[];
     ...
     * @param recursive 
     */
    filesStorages(recursive: boolean): SessionScopeStorage[];
     ...
     * 親ストレージを返します。
     */
    getParentStorage(): SessionScopeStorage;
     ...
     * @param target 
     */
    getRelativePath(target: SessionScopeStorage): string;

    /**
     * ルートストレージを返します。
     */
    getRootStorage(): SessionScopeStorage;
     ...
     */
    listStorages(filterOrRecursive?: object): SessionScopeStorage[];
     ...
     * @param other 
     */
    resolve(other: string): SessionScopeStorage;
